...
function plot_governorates(governorate_parsed_data, delegation_parsed_data)
{
        ...
        var color = d3.scale.linear().domain(r)
                      .range(["#ff9690",
                              "#ff675f",
                              "#ff392e",
                              "#fc0c00",
...
d3.csv("data/poverty_data_par_governorate.csv", function(governorate_data) {
       governorate_parsed_data = {};
       for (i=0; i < governorate_data.length; i++) {
         governorate_parsed_data[governorate_data[i]["Governorate"]] = parseFloat(governorate_data[i]["Poverty"].replace(",", ".")); }
